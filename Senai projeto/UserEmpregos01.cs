    ...
    public partial class UserEmpregos01 : UserControl
    {
        ...
        private void btnCadastrarContrato_Click(object sender, EventArgs e)
        {
            if (ChecarTextos() == true)
            {
                ...
                {
                    MessageBox.Show("Contrato cadastrado com sucesso!", "Cadastro de contrato");
                    LimparTxt();
                    retornarSolicitacaoDgv();
                }
            }
        ...
        private void btnEditarContrato_Click(object sender, EventArgs e)
        {
            if (ChecarTextos() == true)
            {
                ...
                {
                    MessageBox.Show("Contrato editado com sucesso!", "Edição de contrato");
                    LimparTxt();
                    retornarSolicitacaoDgv();
                }
            }
        ...
        private void btnRemoverContrato_Click(object sender, EventArgs e)
        {
            if (ChecarTextos() == true)
            {
                ...
                {
                    MessageBox.Show("Contrato excluído com sucesso!", "Exclusão de contrato");
                    LimparTxt();
                    retornarSolicitacaoDgv();
                }
            }
